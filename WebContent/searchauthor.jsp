...
<%
	...
	String sql = "SELECT * FROM books where author like'"+str+ "%' and price !=''";
				...
				<ul class="menu">
					...
					<li class="li_3"><a class="noclick" href="#" target="_blank">晕车一族</a>
						<dl class="li_3_content">
							...
							<dd>
								<a href="homepage.html" target="_blank"><span>退出</span></a>
							</dd>
...
<!-- 	<div class="search1">
		...
		<div class="search1">
			<select id="option" name="option" class="select1">
				...
				<option value="2"  selected="selected" >按作者搜</option>
			</select>
			 <input id="inputtext" onkeydown="jump()" class="input" type="text" title="searchs" value="<%=str%>"
				name="input" />
