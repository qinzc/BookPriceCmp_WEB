...
<!--注册开始-->
    <div class="reg">
        <form action="newuser.jsp" method="post" name="form1" id="form1">
            <dl>
            ...
            <div class="f_reg_but"><input id="button" name="button" type="submit" value="免费注册" class="r_button"/><span class="clew_txt">如果您已有帐号，可<a href="login.jsp">直接登录</a></span></div>
        </form>                              
    </div>
<!--注册结束-->        
</body>
